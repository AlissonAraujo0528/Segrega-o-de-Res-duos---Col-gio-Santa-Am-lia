...
/**
 * CORRIGIDO: Delega a lógica de edição para a store.
 * A store cuidará de verificar o admin, buscar os dados e fechar o modal.
 */
 ...
 * Lida com o soft delete de uma avaliação.
 */
...
/**
 * CORRIGIDO: Chama a função de exportação real da store.
 */
